...
Aplicación para gestionar Veril y otros sistemas acuáticos de agua dulce,
salada y salobre.
...
- [Alineación requisitos-arquitectura](docs/alineacion-requisitos-arquitectura.md)
- [Desarrollo asistido](docs/desarrollo-asistido.md)
